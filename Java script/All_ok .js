const music = new Audio("/Audio/All_ok/1.m4a");
// music.play();                  
...
const songs = [
  {
    ...
    poster: "/Audio/All_ok/All OK.jpeg"
  },
  {
    id: "2",
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
  e.addEventListener('click', (el) => {
    ...
    postere_master_play.src = `/Audio/All_ok/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href = `/Audio/All_ok/${index}.m4a`;
    //            // SongTitles
...
back.addEventListener('click', () => {
  ...
  music.src = `/Audio/All_ok/${index}.m4a`;
  postere_master_play.src = `/img/${index}.jpeg`;
  music.play();
  masterPlay.classList.remove('bi-play-fill');
  masterPlay.classList.add('bi-pause-fill');
  //            // SongTitles
...
const next_music = () =>{
 ...
 if (index == songs.length) {
  ...
  music.src = `/Audio/${index}.m4a`;
  postere_master_play.src = `/img/All_ok/All ok.jpeg/${index}.jpg`;
  music.play();
  masterPlay.classList.remove('bi-play-fill');
  masterPlay.classList.add('bi-pause-fill');
  download_music.href = `/Audio/All_ok/${index}.m4a`;
